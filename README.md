...
- **즉시 해설** — 정답·오답 직후 한국어 뜻 + 가나 읽기 + **후리가나 + 단어별 한국어 힌트 + 영어 번역**이 달린 예문
- **후리가나 표시** — 예문의 한자 위에 가나 읽기가 작게 자동 표시
- **단어별 한국어 힌트** — 일한 어순이 같다는 점을 살려, 예문 아래에 각 한자 단어의 한국어 뜻을 칩 형태로 표시. 단어 단위 의미 파악에 도움
